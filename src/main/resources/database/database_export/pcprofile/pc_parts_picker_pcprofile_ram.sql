...
LOCK
TABLES `pcprofile_ram` WRITE;
/*!40000 ALTER TABLE `pcprofile_ram` DISABLE KEYS */;
INSERT INTO `pcprofile_ram`
VALUES ('entry-level-amd-build', 'corsair-dominator-platinum-2x8G-3200'),
       ('entry-level-intel-build', 'corsair-vengeance-RGB-pro-2x8G-3000'),
       ('high-end-intel-build', 'corsair-dominator-platinum-2x16G-3600'),
       ('high-end-amd-build', 'g.skill-trident-z-royal-2x8G-3200'),
       ('low-end-intel-build', 'kingston-hyperx-fury-2x8G-2666'),
       ('low-end-amd-build', 'corsair-vengeance-lpx-2x8G-2666'),
       ('streaming-intel-build', 'corsair-vengeance-RGB-pro-2x8G-3000'),
       ('streaming-amd-build', 'corsair-vengeance-RGB-pro-2x8G-3000');
