...
LOCK
TABLES `pcprofile_ssd` WRITE;
/*!40000 ALTER TABLE `pcprofile_ssd` DISABLE KEYS */;
INSERT INTO `pcprofile_ssd`
VALUES ('entry-level-amd-build', 'kingston-a2000-500-m2-nvme'),
       ('entry-level-intel-build', 'kingston-kc600-512-m2-sata'),
       ('high-end-intel-build', 'samsung-870-qvo-1024-m2-sata'),
       ('high-end-amd-build', 'samsung-870-qvo-1024-m2-sata'),
       ('low-end-intel-build', 'kingston-a400-240-m2-sata'),
       ('low-end-amd-build', 'kingston-a400-240-m2-sata'),
       ('streaming-intel-build', 'adata-xpg-spectrix-s40g-rgb-256-m2-nvme'),
       ('streaming-amd-build', 'kingston-kc600-512-m2-sata');
