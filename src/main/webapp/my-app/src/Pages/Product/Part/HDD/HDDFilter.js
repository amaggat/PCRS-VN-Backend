        ...
        <div className="filter">
            ...
            <form className="filter-content" onSubmit={handleSubmit} id="filterForm">
                <div className="form-group pt-2">
                    ...
                    <div className="form-check">
                        <input type="radio" name="manufacturer" value="Western Digital" onChange={handleChange}
                               className="form-check-input" id="Western-Digital"/>
                        <label className="form-check-label" for="Western-Digital">Western Digital</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="manufacturer" value="Seagate" onChange={handleChange}
                               className="form-check-input" id="Seagate"/>
                ...
                <div className="form-group border-top pt-2">
                    ...
                    <div className="form-check">
                        <input type="radio" name="chipset" value="2.5 SATA" onChange={handleChange}
                               className="form-check-input" id="2.5SATA"/>
                        <label className="form-check-label" for="2.5SATA">2.5 SATA</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="chipset" value="3.5 SATA" onChange={handleChange}
                               className="form-check-input" id="3.5SATA"/>
