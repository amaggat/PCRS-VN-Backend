        ...
        <div className="filter">
            ...
            <form className="filter-content" onSubmit={handleSubmit} id="filterForm">
                <div className="form-group pt-2">
                    ...
                    <div className="form-check">
                        <input type="radio" name="manufacturer" value="G.Skill" onChange={handleChange}
                               className="form-check-input" id="G.Skill"/>
                ...
                <div className="form-group border-top pt-2">
                    ...
                    <div className="form-check">
                        <input type="radio" name="sizeOfRam" value="2x8GB" onChange={handleChange}
                               className="form-check-input" id="2x8GB"/>
                        <label className="form-check-label" for="2x8GB">2x8GB</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="sizeOfRam" value="4x8GB" onChange={handleChange}
                               className="form-check-input" id="4x8GB"/>
                        <label className="form-check-label" for="4x8GB">4x8GB</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="sizeOfRam" value="1x16GB" onChange={handleChange}
                               className="form-check-input" id="1x16GB"/>
                        <label className="form-check-label" for="1x16GB">1x16GB</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="sizeOfRam" value="2x16GB" onChange={handleChange}
                               className="form-check-input" id="2x16GB"/>
                        <label className="form-check-label" for="2x16GB">2x16GB</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="sizeOfRam" value="2x32GB" onChange={handleChange}
                               className="form-check-input" id="2x32GB"/>
                ...
                <div className="form-group border-top pt-2">
                    ...
                    <div className="form-check">
                        <input type="radio" name="chipset" value="DDR4" onChange={handleChange}
                               className="form-check-input" id="DDR4"/>
                ...
                <div className="form-group border-top pt-2">
                    ...
                    <div className="form-check">
                        <input type="radio" name="clockSpeed" value="" defaultChecked={true} onChange={handleChange}
                               className="form-check-input" id="clockspeed-all"/>
                        <label className="form-check-label" for="clockspeed-all">All</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="clockSpeed" value="2666" onChange={handleChange}
                               className="form-check-input" id="2666"/>
                        <label className="form-check-label" for="2666">2666</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="clockSpeed" value="3000" onChange={handleChange}
                               className="form-check-input" id="3000"/>
                        <label className="form-check-label" for="3000">3000</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="clockSpeed" value="3200" onChange={handleChange}
                               className="form-check-input" id="3200"/>
                        <label className="form-check-label" for="3200">3200</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="clockSpeed" value="3600" onChange={handleChange}
                               className="form-check-input" id="3600"/>
