        ...
        <div className="filter">
            ...
            <form className="filter-content" onSubmit={handleSubmit} id="filterForm">
                <div className="form-group pt-2">
                    ...
                    <div className="form-check">
                        <input type="radio" name="manufacturer" value="AMD" onChange={handleChange}
                               className="form-check-input" id="AMD"/>
                        <label className="form-check-label" for="AMD">AMD</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="manufacturer" value="intel" onChange={handleChange}
                               className="form-check-input" id="intel"/>
                ...
                <div className="form-group border-top pt-2">
                    ...
                    <div className="form-check">
                        <input type="radio" name="chipset" value="ryzen 3" onChange={handleChange}
                               className="form-check-input" id="ryzen-3"/>
                        <label className="form-check-label" for="ryzen-3">Ryzen 3</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="chipset" value="ryzen 5" onChange={handleChange}
                               className="form-check-input" id="ryzen-5"/>
                        <label className="form-check-label" for="ryzen-5">Ryzen 5</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="chipset" value="ryzen 7" onChange={handleChange}
                               className="form-check-input" id="ryzen-7"/>
                        <label className="form-check-label" for="ryzen-7">Ryzen 7</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="chipset" value="ryzen 9" onChange={handleChange}
                               className="form-check-input" id="ryzen-9"/>
                        <label className="form-check-label" for="ryzen-9">Ryzen 9</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="chipset" value="i3" onChange={handleChange}
                               className="form-check-input" id="i3"/>
                        <label className="form-check-label" for="i3">Core i3</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="chipset" value="i5" onChange={handleChange}
                               className="form-check-input" id="i5"/>
                        <label className="form-check-label" for="i5">Core i5</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="chipset" value="i7" onChange={handleChange}
                               className="form-check-input" id="i7"/>
                        <label className="form-check-label" for="i7">Core i7</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="chipset" value="i9" onChange={handleChange}
                               className="form-check-input" id="i9"/>
                ...
                <div className="form-group border-top pt-2">
                    <label>Core</label>
                    <div className="form-check">
                        <input type="radio" name="cores" value="" defaultChecked={true} onChange={handleChange}
                               className="form-check-input" id="cores-all"/>
                        <label className="form-check-label" for="cores-all">All</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="cores" value="4" onChange={handleChange} className="form-check-input"
                               id="cores-4"/>
                        <label className="form-check-label" for="cores-4">4</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="cores" value="6" onChange={handleChange} className="form-check-input"
                               id="cores-6"/>
                        <label className="form-check-label" for="cores-6">6</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="cores" value="8" onChange={handleChange} className="form-check-input"
                               id="cores-8"/>
                        <label className="form-check-label" for="cores-8">8</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="cores" value="10" onChange={handleChange} className="form-check-input"
                               id="cores-8"/>
                        <label className="form-check-label" for="cores-10">10</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="cores" value="12" onChange={handleChange} className="form-check-input"
                               id="cores-12"/>
                        <label className="form-check-label" for="cores-12">12</label>
                    </div>
                    <div className="form-check">
                        <input type="radio" name="cores" value="16" onChange={handleChange} className="form-check-input"
                               id="cores-16"/>
                ...
                <div className="form-group border-top pt-2">
                    ...
                    <div className="form-check">
                        <input type="radio" name="socket" value="am4" onChange={handleChange} disabled={disable}
                               className="form-check-input" id="socket-am4"/>
                    ...
                    <div className="form-check">
                        <input type="radio" name="socket" value="lga1200" onChange={handleChange} disabled={disable}
                               className="form-check-input" id="socket-lga1200"/>
                    ...
                    <div className="form-check">
                        <input type="radio" name="socket" value="lga1151" onChange={handleChange} disabled={disable}
                               className="form-check-input" id="socket-lga1151"/>
