    ...
    render() {
        return (
            <div className="product white-back">
                ...
                <div className="tab-pane w-container" id="pills-product" role="tabpanel"
                        ...
                        <div className="col-10">
                            ...
                            <table className="table">
                                ...
                                <tr className="product-title">
                                    ...
                                    <th scope="col" className="font-weight-bold" id="external-bays">External 5.25"
                                        Bays
                                    </th>
                                    <th scope="col" className="font-weight-bold" id="internal-bays">Internal 5.25"
                                        Bays
                                    </th>
